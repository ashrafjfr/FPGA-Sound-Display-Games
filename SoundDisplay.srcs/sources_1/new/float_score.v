...
module float_score(input clock, point, reset, left, right, output reg [3:0] an, reg [7:0] seg);
    reg [7:0] digits [0:9];
    ...
    always @(posedge clock) begin
        ...
        if ((left == 1 || right == 1) && score_flag == 1) score_flag <= 0; 
        counter <= counter + 1;
    end   
endmodule